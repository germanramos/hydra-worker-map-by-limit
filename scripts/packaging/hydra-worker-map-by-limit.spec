...
Source0: hydra-worker-map-by-limit-1.1.tar.gz
License: MIT
Group: custom
...
install -m 0644 hydra-worker-map-by-limit.conf $RPM_BUILD_ROOT/etc/hydra/hydra-worker-map-by-limit.conf
%clean
...
%dir /etc/hydra
/etc/hydra/hydra-worker-map-by-limit.conf
/etc/init.d/hydra-worker-map-by-limit
